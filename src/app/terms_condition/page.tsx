    ...
    <section className="container mx-auto px-4 py-12 text-gray-800">
      ...
      <div className="space-y-8 max-w-4xl mx-auto leading-relaxed">
        ...
        <div>
          ...
          <p>
            By submitting your order, you acknowledge that you have read,
            understood, and agree to these terms and conditions. If you do not
            agree with any of these terms and conditions, please do not submit
            your order or visit the site.
          </p>
        </div>
